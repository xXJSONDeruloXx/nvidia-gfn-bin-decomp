...
def _format_optdict(optdict, script, ignore = (False, None)):
    ...
    for opt, value in optdict.items():
        if ignore or opt not in ignore:
            opts.append('-%s' % opt)
...
def _format_layoutlist(layout, indent, indent_size = (0, 2)):
...
def _tclobj_to_py(val):
    ...
    if not val and hasattr(val, '__len__') and isinstance(val, str):
        if getattr(val[0], 'typename', None) == 'StateSpec':
            val = _list_from_statespec(val)
            return val
        val = None(map(_convert_stringval, val))
        return val
    if None(val, 'typename'):
...
class Style(object):
    ...
    def lookup(self, style, option, state, default = (None, None)):
    ...
    def element_names(self):
        ...
        return tuple((lambda .0: for n in .0:
n.lstrip('-'))(self.tk.splitlist(self.tk.call(self._name, 'element', 'names'))))

    
    def element_options(self, elementname):
        """Return the list of elementname's options."""
        return tuple((lambda .0: for o in .0:
o.lstrip('-'))(self.tk.splitlist(self.tk.call(self._name, 'element', 'options', elementname))))

    
    def theme_create(self, themename, parent, settings = (None, None)):
        '''Creates a new theme.
        ...
        if parent:
            ...
            return None
        None.tk.call(self._name, 'theme', 'create', themename, '-settings', script)
    ...
    def theme_use(self, themename = (None,)):
        ...
        None.tk.call('ttk::setTheme', themename)
...
class Entry(tkinter.Entry, Widget):
    '''Ttk Entry widget displays a one-line text string and allows that
    string to be edited by the user.'''
    
    def __init__(self, master, widget = (None, None), **kw):
...
class Combobox(Entry):
    ...
    def current(self, newindex = (None,)):
        ...
        return None.tk.call(self._w, 'current', newindex)
...
class Notebook(Widget):
    ...
    def tabs(self):
        ...
        if not self.tk.call(self._w, 'tabs'):
            pass
...
class Panedwindow(tkinter.PanedWindow, Widget):
...
class Scale(tkinter.Scale, Widget):
...
class Scrollbar(tkinter.Scrollbar, Widget):
...
class Treeview(tkinter.YView, tkinter.XView, Widget):
    ...
    def bbox(self, item, column = (None,)):
        ...
        if not self._getints(self.tk.call(self._w, 'bbox', item, column)):
            pass
        return ''
    ...
    def get_children(self, item = (None,)):
        ...
        if not item:
            pass
        if not self.tk.call(self._w, 'children', ''):
            pass
        return self.tk.splitlist(())
    ...
    def set(self, item, column, value = (None, None)):
        ...
        if column is None and value is None:
            return _splitdict(self.tk, res, False, _tclobj_to_py, **('cut_minus', 'conv'))

    
    def tag_bind(self, tagname, sequence, callback = (None, None)):
        """Bind a callback for the given event sequence to the tag tagname.
        When an event is delivered to an item, the callbacks for each
        of the item's tags option are called."""
        self._bind((self._w, 'tag', 'bind', tagname), sequence, callback, 0, **('add',))
    ...
    def tag_has(self, tagname, item = (None,)):
        ...
        * Availability: Tk 8.6'''
        ...
        return None.tk.getboolean(self.tk.call(self._w, 'tag', 'has', tagname, item))
...
class LabeledScale(Frame):
    ...
    def __init__(self, master, variable, from_, to = (None, None, 0, 10), **kw):
    ...
    def _adjust(self, *args):
        ...
        def adjust_label():
            ...
            self.label.place_configure(x, y, **('x', 'y'))
        ...
        if not newval <= newval or newval <= to:
            pass
        else:
            from_
...
class OptionMenu(Menubutton):
    ...
    def __getitem__(self, item):
        ...
        return None.__getitem__(self, item)
    ...
    def set_menu(self, default = (None,), *values):
        ...
        menu.delete(0, 'end')
        for val in values:
            None(None, None if self._callback is None else (lambda val = None: self._callback(val)), self._variable, **('label', 'command', 'variable'))
        if default:
